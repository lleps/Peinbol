...
public class Matrix {
    ...
    public static void multiplyMM(float[] result, int resultOffset,
        ...
        m.set(lhs);
        m.mul(new Matrix4f().set(rhs));
        m.get(result, resultOffset);
        //if (resultOffset != 0 || lhsOffset != 0 || rhsOffset != 0) {
        //    System.out.println("[[[MM]]] Called " + resultOffset + " " + lhsOffset + " " + rhsOffset);
        //}
    }
    ...
    public static void multiplyMV(float[] resultVec,
        ...
        Vector4f vec = new Vector4f(rhsVec[0], rhsVec[1], rhsVec[2], rhsVec[3]);
        Vector4f result = new Vector4f();
        vec.mul(new Matrix4f().set(lhsMat), result);
        resultVec[0] = result.x;
        resultVec[1] = result.y;
        resultVec[2] = result.z;
        resultVec[3] = result.w;
    }
