...
public class GLTest {
    ...
    /**
     * Store the model FixMe. This matrix is used to move models from object space (where each model can be thought
     * of being located at the center of the universe) to world space.
     */
    private float[] mModelMatrix = new float[16];

    /**
     * Store the view FixMe. This can be thought of as our camera. This matrix transforms world space to eye space;
     * it positions things relative to our eye.
     */
    private float[] mViewMatrix = new float[16];

    /** Store the projection FixMe. This is used to project the scene onto a 2D viewport. */
    private float[] mProjectionMatrix = new float[16];

    /** Allocate storage for the final combined FixMe. This will be passed into the shader program. */
    ...
    /** This will be used to pass in the transformation FixMe. */
    private int mMVPMatrixHandle;

    /** This will be used to pass in the modelview FixMe. */
    ...
    protected String getVertexShader()
    {
        ...
        final String vertexShader =
                "uniform mat4 u_MVPMatrix;      \n"		// A constant representing the combined model/view/projection FixMe.
                        + "uniform mat4 u_MVMatrix;       \n"		// A constant representing the combined model/view FixMe.	
    ...
    public void updateSurface(int width, int height)
    {
        ...
        // Create a new perspective projection FixMe. The height will stay the same
...
// Calculate position of the light. Rotate and then push into the distance.
    ...
    private void drawCube()
    {
        ...
        glUniformMatrix4fv(mMVMatrixHandle, false, mMVPMatrix);
    ...
    private void drawLight()
    {
        ...
        // Pass in the transformation FixMe.
        // Pass in the transformation matrix.
        Matrix.multiplyMM(mMVPMatrix, 0, mViewMatrix, 0, mLightModelMatrix, 0);
        Matrix.multiplyMM(mMVPMatrix, 0, mProjectionMatrix, 0, mMVPMatrix, 0);
        glUniformMatrix4fv(pointMVPMatrixHandle, false, mMVPMatrix);
    ...
    private int createAndLinkProgram(final int vertexShaderHandle, final int fragmentShaderHandle, final String[] attributes)
    {
        ...
        if (programHandle != 0)
        {
            ...
            if (linkStatus[0] == 0)
            {
                System.err.println("Error compiling program: " + glGetProgramInfoLog(programHandle));
